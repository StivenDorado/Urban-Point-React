...
function Funcionamiento() {
    return (
        <div className="p-8 flex flex-col items-center">
            <h1 className="text-2xl font-bold mb-4 text-gray-600">Acerca de Urban Point</h1>
            <nav className="mb-4">
            ...
            <p>
                <b className='text-gray-600'>UrbanPoint funciona como una plataforma digital que facilita la búsqueda de alojamiento temporal para aprendices del SENA CTPI. El funcionamiento de UrbanPoint se puede dividir en los siguientes pasos:</b>
            </p>
            <br />
